...
export const fetchModels = async (): Promise<
  AgentApiResult<{ models: FastGPTModel[]; voiceModels: VoiceModel[] }>
> => {
  try {
...
export const addAgent = async (
  agent: Omit<FastGPTApp, 'id' | 'createdAt' | 'updatedAt'>
): Promise<AgentApiResult<FastGPTApp>> => {
  try {
