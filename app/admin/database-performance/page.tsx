    ...
    <div className='container mx-auto p-6 space-y-6'>
      ...
      <div className='flex items-center justify-between'>
        ...
        <div className='flex items-center space-x-2'>
          <Button variant='outline' size='sm' onClick={fetchPerformanceData} disabled={refreshing}>
            <RefreshCw className={`h-4 w-4 mr-2 ${refreshing ? 'animate-spin' : ''}`} />
            刷新
          </Button>
          <Button size='sm' onClick={triggerOptimization} disabled={refreshing}>
          ...
          <TabsContent value='overview' className='space-y-6'>
            <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
              ...
              <Card>
                ...
                <CardContent>
                  <div className='flex items-center space-x-2'>
                    ...
                    <span
                      className={`font-semibold ${getStatusColor(performanceData.overview.monitoring.status)}`}
                    >
              ...
              <Card>
                ...
                <CardContent>
                  <div className='text-2xl font-bold'>
                    {performanceData.overview.optimization.componentsActive}/
                    {performanceData.overview.optimization.totalComponents}
                  </div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className='text-2xl font-bold'>
                    {performanceData.overview.health.score}/100
                  </div>
                  <Progress value={performanceData.overview.health.score} className='mt-2' />
                  <Badge
                    variant={
                      performanceData.overview.health.status === 'excellent'
                        ? 'default'
                        : 'secondary'
                    }
                    className='mt-2'
                ...
                <CardContent className='space-y-4'>
                  <div className='flex justify-between items-center'>
                    ...
                    <span className='font-semibold'>
                      {performanceData.metrics.connectionPool.active}
                    </span>
                  </div>
                  <div className='flex justify-between items-center'>
                    <span className='text-sm'>空闲连接</span>
                    <span className='font-semibold'>
                      {performanceData.metrics.connectionPool.idle}
                    </span>
                  </div>
                  <div className='flex justify-between items-center'>
                    <span className='text-sm'>总连接数</span>
                    <span className='font-semibold'>
                      {performanceData.metrics.connectionPool.total}
                    </span>
                  </div>
                  <div>
                    <div className='flex justify-between items-center mb-2'>
                      ...
                      <span className='font-semibold'>
                        {performanceData.metrics.connectionPool.utilization}%
                      </span>
                    </div>
              ...
              <Card>
                ...
                <CardContent className='space-y-4'>
                  <div className='flex justify-between items-center'>
                    ...
                    <span className='font-semibold'>
                      {performanceData.metrics.performance.avgQueryTime}ms
                    </span>
                  </div>
                  <div className='flex justify-between items-center'>
                    <span className='text-sm'>慢查询数量</span>
                    <span className='font-semibold text-red-600'>
                      {performanceData.metrics.performance.slowQueries}
                    </span>
                  </div>
                  <div className='flex justify-between items-center'>
                    <span className='text-sm'>总查询数</span>
                    <span className='font-semibold'>
                      {performanceData.metrics.performance.totalQueries}
                    </span>
                  </div>
                  <div>
                    <div className='flex justify-between items-center mb-2'>
                      ...
                      <span className='font-semibold'>
                        {performanceData.metrics.performance.cacheHitRate}%
                      </span>
                    </div>
                  ...
                  <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
                    <div>
                      <div className='flex justify-between items-center mb-2'>
                        ...
                        <span className='font-semibold'>
                          {performanceData.metrics.resources.cpuUsage}%
                        </span>
                      </div>
                    ...
                    <div>
                      <div className='flex justify-between items-center mb-2'>
                        ...
                        <span className='font-semibold'>
                          {performanceData.metrics.resources.memoryUsage}%
                        </span>
                      </div>
                    ...
                    <div>
                      <div className='flex justify-between items-center mb-2'>
                        ...
                        <span className='font-semibold'>
                          {performanceData.metrics.resources.diskUsage}%
                        </span>
                      </div>
