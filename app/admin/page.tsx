...
import { Database, Activity, Users, Shield, ArrowRight } from 'lucide-react';
  ...
  return (
    <div className='p-6'>
      ...
      <div className='mb-8'>
        ...
        <p className='text-gray-600 dark:text-gray-400 mt-2'>系统概览和关键指标监控</p>
      </div>
      ...
      <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8'>
        ...
        <div className='bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow'>
          ...
          <h3 className='text-lg font-semibold text-gray-900 dark:text-white mb-2'>数据库性能</h3>
        ...
        <div className='bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow'>
          ...
          <h3 className='text-lg font-semibold text-gray-900 dark:text-white mb-2'>系统监控</h3>
          <p className='text-gray-600 dark:text-gray-400 text-sm mb-4'>
            实时监控系统状态和性能指标
          </p>
          <Link
        ...
        <div className='bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow'>
          ...
          <h3 className='text-lg font-semibold text-gray-900 dark:text-white mb-2'>用户管理</h3>
          <p className='text-gray-600 dark:text-gray-400 text-sm mb-4'>管理用户账户和权限设置</p>
          <Link
            href='/admin/users'
            className='inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-sm font-medium'
          >
        ...
        <div className='bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6 hover:shadow-md transition-shadow'>
          ...
          <h3 className='text-lg font-semibold text-gray-900 dark:text-white mb-2'>安全中心</h3>
          <p className='text-gray-600 dark:text-gray-400 text-sm mb-4'>安全策略和访问控制管理</p>
          <Link
            href='/admin/security'
            className='inline-flex items-center text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 text-sm font-medium'
          >
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        ...
        <div className='bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6'>
          <h3 className='text-lg font-semibold text-gray-900 dark:text-white mb-4'>系统指标</h3>
