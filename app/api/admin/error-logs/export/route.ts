...
export const GET = createApiRoute(
  ...
  async (req: NextRequest, { validatedQuery }) => {
    ...
    if (!authResult.success) {
      return ApiResponseWrapper.error(ErrorCode.AUTHORIZATION_ERROR, 'Unauthorized access', null, 403);
    }
    ...
    try {
      ...
      return ApiResponseWrapper.error(ErrorCode.INTERNAL_SERVER_ERROR, 'Failed to export error logs', error, 500);
    }
  }
);
