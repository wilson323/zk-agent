...
export function AgentCard({ agent, onClick, showMetrics = true, className = '' }: AgentCardProps) {
        ...
        {showMetrics && (
          <div className='grid grid-cols-2 gap-3 text-xs'>
            ...
            <div className='flex items-center gap-1'>
              ...
              <span className='font-medium'>{formatNumber(agent.metrics.dailyActiveUsers)}</span>
        ...
        <div className='w-full space-y-2'>
          ...
          <div className='flex flex-wrap gap-1'>
            ...
            {agent.capabilities.length > 2 && (
              <Badge variant='outline' className='text-xs px-2 py-0.5 h-auto text-muted-foreground'>
