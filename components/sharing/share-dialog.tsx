                  ...
                  <div className='space-y-2'>
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        setConfig(prev => ({
                          ...prev,
                          expiresIn: Number.parseInt(value) || undefined,
                        }))
                      }
                    >
                      <SelectTrigger>
                  ...
                  <div className='space-y-2'>
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        setConfig(prev => ({
                          ...prev,
                          viewLimit: Number.parseInt(value) || undefined,
                        }))
                      }
                    >
                      <SelectTrigger>
                ...
                <div className='space-y-3'>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        setConfig(prev => ({ ...prev, allowDownload: checked }))
                      }
                    />
                  </div>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        setConfig(prev => ({ ...prev, allowCopy: checked }))
                      }
                    />
                  </div>
                </div>
              ...
              <div className='space-y-4'>
                ...
                <div className='grid grid-cols-2 gap-4 text-sm text-gray-600 dark:text-gray-400'>
                  <div className='flex items-center'>
                    ...
                    {config.expiresIn
                      ? `${Math.ceil(config.expiresIn / (24 * 60 * 60 * 1000))}天后过期`
                      : '永不过期'}
                  </div>
                  <div className='flex items-center'>
                ...
                <div className='flex space-x-2'>
                  ...
                  <Button
                    ...
                    className='flex-1 bg-[#6cb33f] hover:bg-[#5a9635]'
                  >
                    完成
                  </Button>
                </div>
