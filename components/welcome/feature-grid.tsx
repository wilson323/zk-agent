    ...
    () => [
      {
        ...
        title: '智能对话',
        description:
          '基于先进的大语言模型，提供自然流畅的多轮对话体验，支持上下文理解和专业领域问答',
        icon: MessageSquare,
        category: '核心功能',
    ...
    <>
      ...
      <div className='mt-12 text-center'>
        <p className='text-sm text-gray-500 dark:text-gray-400'>
          共 <span className='font-semibold text-blue-600'>{filteredFeatures.length}</span>{' '}
          个功能特性
          {activeCategory !== '全部' && (
            <span>
              {' '}
              • 分类: <span className='font-semibold'>{activeCategory}</span>
            </span>
          )}
        </p>
      </div>
