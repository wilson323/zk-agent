  ...
  return (
    <Card
      className={`group relative overflow-hidden transition-all duration-500 border-0 bg-white/90 backdrop-blur-sm dark:bg-gray-800/90 shadow-lg ${
        isActive ? 'scale-105 shadow-xl' : 'scale-95 opacity-75 hover:scale-100 hover:opacity-90'
      }`}
    >
      {/* 背景装饰 */}
...
const CarouselControls = memo<{
  ...
  return (
    <div className='flex items-center justify-center space-x-4 mt-8'>
      ...
      <Button variant='outline' size='sm' onClick={onNext} className='h-10 w-10 rounded-full p-0'>
