              ...
              <CardContent>
                <div className='space-y-2'>
                  <div className='flex items-center justify-between'>
                    ...
                    <Badge
                      variant={systemStatus.connection.isConnected ? 'default' : 'destructive'}
                    >
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='text-sm font-medium'>
                      {systemStatus.connection.errorCount}
                    </span>
                  </div>
              ...
              <CardContent>
                <div className='space-y-2'>
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='text-sm font-medium'>
                      {systemStatus.memory.activeSessions}
                    </span>
                  </div>
                  <div className='flex items-center justify-between'>
              ...
              <CardContent>
                <div className='space-y-2'>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <span className='text-sm font-medium'>
                      {systemStatus.performance.totalRequests}
                    </span>
                  </div>
                  <div className='mt-2'>
                    <div className='flex items-center justify-between text-xs mb-1'>
