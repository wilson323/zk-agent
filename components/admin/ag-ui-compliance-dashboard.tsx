...
import type {
  ...
  ComplianceReport,
} from '@/lib/ag-ui/compliance/agent-compliance-audit';
      ...
      <Card key={report.agentId} className='mb-4'>
        <CardHeader>
          <div className='flex items-center justify-between'>
            <CardTitle className='text-lg'>
              {agentNames[report.agentId] || report.agentId}
            </CardTitle>
        ...
        <CardContent>
          <div className='space-y-4'>
            ...
            <div className='grid grid-cols-2 gap-4'>
              <div>
                ...
                <div className='flex justify-between text-sm'>
                  ...
                  <span
                    className={
                      report.definitionCompliance.isCompliant ? 'text-green-600' : 'text-red-600'
                    }
                  >
              ...
              <div>
                ...
                <div className='flex justify-between text-sm'>
                  ...
                  <span
                    className={
                      report.runtimeCompliance.isCompliant ? 'text-green-600' : 'text-red-600'
                    }
                  >
            ...
            {/* 错误和警告 */}
            {(report.definitionCompliance.errors.length > 0 ||
              report.runtimeCompliance.errors.length > 0) && (
              <Alert variant='destructive'>
                ...
                <AlertDescription>
                  ...
                  <ul className='list-disc list-inside text-sm'>
                    {[
                      ...report.definitionCompliance.errors,
                      ...report.runtimeCompliance.errors,
                    ].map((error, index) => (
            ...
            {(report.definitionCompliance.warnings.length > 0 ||
              report.runtimeCompliance.warnings.length > 0) && (
              <Alert>
                ...
                <AlertDescription>
                  ...
                  <ul className='list-disc list-inside text-sm'>
                    {[
                      ...report.definitionCompliance.warnings,
                      ...report.runtimeCompliance.warnings,
                    ].map((warning, index) => (
          ...
          <TabsContent value='overview' className='space-y-4'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-4 gap-4'>
              ...
              <Card>
                ...
                <CardContent>
                  {renderComplianceStatus(auditResult.isCompliant, auditResult.overallScore)}
                </CardContent>
              </Card>
            </div>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  最后更新: {new Date(auditResult.timestamp).toLocaleString()}
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className='space-y-4'>
                  ...
                  <div className='text-sm text-muted-foreground'>
                    {auditResult.compliantAgents} / {auditResult.totalAgents}{' '}
                    个智能体完全符合AG-UI协议
                  </div>
                </div>
              </CardContent>
