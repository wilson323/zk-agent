    ...
    >
      ...
      {stats && (
        <div className='grid grid-cols-1 md:grid-cols-5 gap-4'>
          <StatCard title='总错误数' icon={AlertCircle} value={stats.total.toLocaleString()} />
          <StatCard
            title='未解决'
            icon={XCircle}
          ...
          <CardContent>
            {isLoading ? (
              ...
              <div className='space-y-2 max-h-96 overflow-y-auto'>
                ...
                {logs.length === 0 && (
                  <div className='text-center py-8 text-gray-500'>没有找到错误日志</div>
                )}
              </div>
            )}
          </CardContent>
