        ...
        <TabsContent value='config'>
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                配置您的FastGPT API密钥和端点，以便应用程序可以与FastGPT服务通信。
              </CardDescription>
            </CardHeader>
            <form onSubmit={handleSubmit}>
              <CardContent className='space-y-4'>
                ...
                {testStatus === 'success' && <StatusMessage type='success' message={testMessage} />}

                {testStatus === 'error' && <StatusMessage type='error' message={testMessage} />}
              </CardContent>
