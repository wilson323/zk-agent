...
export class ConnectionFactory {
  private static connectionTypes = new Map<string, new (id: string, config: DatabaseConnectionConfig) => DatabaseConnection>();
   ...
   * 注册连接类型
   */
  static register(type: string, connectionClass: new (id: string, config: DatabaseConnectionConfig) => DatabaseConnection): void {
