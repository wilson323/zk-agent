...
import { DatabaseMetrics, CacheConfig } from './unified-interfaces';
...
export class CacheStrategyManager extends EventEmitter {
  ...
  private updateStats(): void {
    ...
    this.performanceMetrics.evictionRate =
      this.stats.evictions / Math.max(1, this.stats.totalRequests);
  }
