...
export const TESTIMONIALS_DATA: TestimonialData[] = [
  {
    ...
    rating: 5,
    content:
      'CAD分析功能非常强大，帮助我们团队快速识别设计问题，大大提升了工作效率。AI的分析结果准确度很高，为我们的项目节省了大量时间。',
    date: '2024-12-15',
    category: 'CAD分析',
    isVerified: true,
    likes: 128,
  },
  {
    ...
    rating: 5,
    content:
      '海报生成器的效果超出预期！AI能够理解我的设计需求，生成的作品既专业又有创意。现在我们的设计效率提升了300%。',
    date: '2024-12-14',
    category: '海报生成',
    isVerified: true,
    likes: 95,
  },
  {
    ...
    rating: 4,
    content:
      '智能对话助手的回答质量很高，能够准确理解复杂的业务问题。团队成员都很喜欢使用，显著提升了我们的工作协作效率。',
    date: '2024-12-13',
    category: '智能对话',
    isVerified: true,
    likes: 76,
  },
  {
    ...
    rating: 5,
    content:
      '平台的数据分析功能非常全面，可视化效果出色。AI能够自动发现数据中的关键洞察，为我们的决策提供了强有力的支持。',
    date: '2024-12-12',
    category: '数据分析',
    isVerified: true,
    likes: 112,
  },
  {
    ...
    rating: 5,
    content:
      'API接口设计得很好，文档详细，集成简单。代码审查功能帮助我们团队提升了代码质量，减少了bug数量。',
    date: '2024-12-11',
    category: '开发工具',
    isVerified: true,
    likes: 89,
  },
  {
    ...
    rating: 4,
    content:
      '内容创作助手帮助我们快速生成高质量的营销文案，不同风格的内容都能很好地满足需求。团队的内容产出效率提升了很多。',
    date: '2024-12-10',
    category: '内容创作',
    isVerified: true,
    likes: 67,
...
export const QUICK_START_ITEMS = [
  {
    ...
    title: '智能对话',
    description:
      '与AI助手进行自然语言对话，获得专业的问题解答和建议。支持多轮对话、上下文理解和个性化回复。',
    href: '/chat',
    badge: '热门',
  ...
  },
  {
    ...
    title: 'CAD分析',
    description:
      '上传CAD文件，获得专业的工程分析和优化建议。支持多种文件格式，提供详细的分析报告。',
    href: '/cad-analyzer',
    badge: '专业',
  ...
  },
  {
    ...
    title: '海报生成',
    description:
      '使用AI技术快速生成专业的海报和设计作品。提供多种模板和自定义选项，满足各种设计需求。',
...
export const FEATURED_AGENTS: AgentData[] = [
  {
    ...
    name: 'FastGPT助手',
    description:
      '基于FastGPT的智能对话助手，支持多轮对话和上下文理解，为您提供专业的问题解答和智能建议。',
  ...
  },
  {
    ...
    name: 'CAD分析专家',
    description:
      '专业的CAD文件分析工具，支持多种格式，提供详细的工程分析和优化建议，助力工程设计。',
  ...
  },
  {
    ...
    name: '海报生成器',
    description:
      '智能海报设计工具，提供丰富的模板和自定义选项，快速生成专业设计作品，满足各种场景需求。',
